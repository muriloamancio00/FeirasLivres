            ...
            <tbody>
                <tr v-for="obj, chave in dadosFiltrados" :key="chave">
                    ...
                    <td v-if="visualizar.visivel || atualizar.visivel || remover.visivel">
                        ...
                        <button v-if="atualizar.visivel" class="btn btn-outline-dark btn-sm">Atualizar</button>
                        <button v-if="remover.visivel" class="btn btn-outline-danger btn-sm" :data-toggle="visualizar.dataToggle" :data-target="remover.dataTarget" @click="setStore(obj)">Remover</button>
                    </td>
                </tr>
            </tbody>
        </table>
